...
func main() {
	...
	services := &service.Services{
		...
		Backup:    service.NewBackupService("/app/backups", cfg.DatabaseURL),
...
func setupRoutes(app *fiber.App, services *service.Services, repos *repository.Repositories, cfg *config.Config) {
	...
	adminHandler := handler.NewAdminHandler(services.Auth, services.Settings, services.Backup, services.Audit)
